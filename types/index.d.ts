...
export = ts_steam_user;

declare class ts_steam_user {
    constructor(...args: any[]);

    activateSharingAuthorization(ownerSteamID: any, deviceToken: any): void;

    addAuthorizedBorrowers(borrowersSteamID: any, callback: any): any;

    addFriend(steamID: any, callback: any): any;

    addFriendToGroup(groupID: any, userSteamID: any, callback: any): any;

    authorizeLocalSharingDevice(deviceName: any, callback: any): any;
    ...
    deauthorizeSharingDevice(deviceToken: any, callback: any): any;
    ...
    getAuthorizedBorrowers(options: any, callback: any): any;

    getAuthorizedSharingDevices(options: any, callback: any): any;

    getCDNAuthToken(appID: any, depotID: any, hostname: any, callback: any): any;

    getChatHistory(steamID: any, callback: any): any;

    getContentServers(appid: any, callback: any): any;
    ...
    getEquippedProfileItems(steamID: any, options: any, callback: any): any;
    ...
    getOwnedProfileItems(options: any, callback: any): any;
    ...
    getUserOwnedApps(steamID: any, options: any, callback: any): any;
    ...
    removeAuthorizedBorrowers(borrowersSteamID: any, callback: any): any;
    ...
    requestRichPresence(appid: any, steamIDs: any, language: any, callback: any): any;
    ...
    setProfileBackground(backgroundAssetID: any, callback: any): any;
    ...
    static EAppControllerSupportLevel: {
        "0": string;
        "1": string;
        "2": string;
        Full: number;
    ...
    static EAppInfoSection: {
        ...
        "8": string;
        "9": string;
        Albummetadata: number;
        All: number;
        Broadcastgamedata: number;
        Common: number;
        Community: number;
        Computed: number;
        Config: number;
    ...
    static EBroadcastChatPermission: {
        "0": string;
        "1": string;
        OwnsApp: number;
        Public: number;
    ...
    static EChatRoomGroupAction: {
        ...
        "9": string;
        Ban: number;
        ChangeGroupRoles: number;
        ChangeTaglineAvatarName: number;
        ChangeUserRoles: number;
        Chat: number;
        CreateRenameDeleteChannel: number;
        Default: number;
        Invite: number;
        Kick: number;
        MentionAll: number;
        SetWatchingBroadcast: number;
        ViewHistory: number;
    };

    static EChatRoomGroupPermissions: {
        "0": string;
        "1": string;
        "16": string;
        "2": string;
    ...
    static EContentDeltaChunkDataLocation: {
        "0": string;
        "1": string;
        AfterProtobuf: number;
        InProtobuf: number;
    };
    ...
    static EControllerElementType: {
        ...
        ButtonA: number;
        ButtonB: number;
        ButtonBumperLeft: number;
        ButtonBumperRight: number;
        ButtonJoystickLeft: number;
        ButtonJoystickRight: number;
        ButtonMacro0: number;
        ButtonMacro1: number;
        ButtonMacro1Finger: number;
        ButtonMacro2: number;
        ButtonMacro2Finger: number;
        ButtonMacro3: number;
        ButtonMacro4: number;
        ButtonMacro5: number;
        ButtonMacro6: number;
        ...
        ButtonStart: number;
        ButtonSteam: number;
        ButtonTriggerLeft: number;
        ButtonTriggerRight: number;
        ButtonX: number;
        ButtonY: number;
        DPad: number;
        JoystickLeft: number;
        ...
        None: number;
        Paste: number;
        PlaybackInput: number;
        RecordInput: number;
        Thumb: number;
        TrackpadCenter: number;
        TrackpadLeft: number;
        TrackpadRight: number;
    };
    ...
    static EDisplayStatus: {
        ...
        "9": string;
        AvailForFree: number;
        AvailGuestPass: number;
        AvailToBorrow: number;
        BorrowerLocked: number;
        DownloadDisabled: number;
        DownloadPaused: number;
        ...
        ReadyToPreload: number;
        RegionRestricted: number;
        Running: number;
        Synchronizing: number;
        Uninstalling: number;
        UpdateDisabled: number;
        UpdatePaused: number;
        UpdateQueued: number;
    ...
    static EEconTradeResponse: {
        ...
        Declined: number;
        Disabled: number;
        DisabledInPartnerRegion: number;
        DisabledInRegion: number;
    ...
    static EExternalAccountType: {
        ...
        "6": string;
        "7": string;
        k_EExternalFacebookAccount: number;
        k_EExternalFacebookPage: number;
        k_EExternalGoogleAccount: number;
        k_EExternalNone: number;
        k_EExternalSteamAccount: number;
        k_EExternalTwitchAccount: number;
        k_EExternalTwitterAccount: number;
        k_EExternalYouTubeChannelAccount: number;
    };
    ...
    static EInputMode: {
        ...
        Controller: number;
        Mouse: number;
        MouseAndController: number;
        Unknown: number;
    };

    static EInternalAccountType: {
        "1": string;
        "2": string;
        "3": string;
        "4": string;
        k_EInternalAppType: number;
        k_EInternalBroadcastChannelType: number;
        k_EInternalClanType: number;
        k_EInternalSteamAccountType: number;
    };
    ...
    static EMsgClanAccountFlags: {
        "1": string;
        "16": string;
        "2": string;
        "4": string;
        "8": string;
        k_EMsgClanAccountFlagDisabled: number;
        k_EMsgClanAccountFlagLarge: number;
        k_EMsgClanAccountFlagLocked: number;
        k_EMsgClanAccountFlagOGG: number;
        k_EMsgClanAccountFlagPublic: number;
    };
    ...
    static EPaymentMethod: {
        ...
        MangirKart: number;
        MasterComp: number;
        MasterSubscription: number;
        MastercardBrazil: number;
        MoPay: number;
        MobileWalletJapan: number;
        MoneyBookers: number;
        Multibanco: number;
        None: number;
        OEMTicket: number;
    ...
    static EProtoAppType: {
        ...
        "8": string;
        "8192": string;
        k_EAppTypeApplication: number;
        k_EAppTypeBeta: number;
        k_EAppTypeComic: number;
        k_EAppTypeConfig: number;
        k_EAppTypeDLC: number;
        k_EAppTypeDemo: number;
        k_EAppTypeDepotOnly: number;
        k_EAppTypeDeprected: number;
        k_EAppTypeDriver: number;
        k_EAppTypeFranchise: number;
        k_EAppTypeGame: number;
        k_EAppTypeGuide: number;
        k_EAppTypeHardware: number;
        k_EAppTypeInvalid: number;
        k_EAppTypeMusicAlbum: number;
        k_EAppTypePlugin: number;
        k_EAppTypeSeries: number;
        k_EAppTypeShortcut: number;
        k_EAppTypeTool: number;
        k_EAppTypeVideo: number;
    };

    static EProtoClanEventType: {
        "1": string;
        "10": string;
        "11": string;
        "12": string;
        ...
        "8": string;
        "9": string;
        k_EClanBetaReleaseEvent: number;
        k_EClanBroadcastEvent: number;
        k_EClanChatEvent: number;
        k_EClanCrosspostEvent: number;
        k_EClanDLCReleaseEvent: number;
        k_EClanDevStreamEvent: number;
        k_EClanESportTournamentStreamEvent: number;
        k_EClanFamousStreamEvent: number;
        k_EClanFreeTrial: number;
        k_EClanFutureReleaseEvent: number;
        k_EClanGameEvent: number;
        k_EClanGameItemSalesEvent: number;
        k_EClanGameReleaseEvent: number;
        k_EClanGameSalesEvent: number;
        k_EClanIRLEvent: number;
        k_EClanInGameBonusXPEvent: number;
        k_EClanInGameChallengeEvent: number;
        k_EClanInGameContentReleaseEvent: number;
        k_EClanInGameContestEvent: number;
        k_EClanInGameEventGeneral: number;
        k_EClanInGameLootEvent: number;
        k_EClanInGamePerksEvent: number;
        k_EClanMajorUpdateEvent: number;
        k_EClanMeetingEvent: number;
        k_EClanMusicAndArtsEvent: number;
        k_EClanNewsEvent: number;
        k_EClanOtherEvent: number;
        k_EClanPartyEvent: number;
        k_EClanPreAnnounceMajorUpdateEvent: number;
        k_EClanSeasonRelease: number;
        k_EClanSeasonUpdate: number;
        k_EClanSmallUpdateEvent: number;
        k_EClanSpecialCauseEvent: number;
        k_EClanSportsEvent: number;
        k_EClanTripEvent: number;
    };
    ...
    static EPublishedFileQueryType: {
        ...
        NotYetRated: number;
        RankedByAveragePlaytimeTrend: number;
        RankedByInappropriateContentRating: number;
        RankedByLifetimeAveragePlaytime: number;
        RankedByLifetimePlaytimeSessions: number;
        RankedByNumTimesReported: number;
        RankedByPlaytimeSessionsTrend: number;
        RankedByPlaytimeTrend: number;
        RankedByPublicationDate: number;
        RankedByTextSearch: number;
        RankedByTotalPlaytime: number;
        RankedByTotalUniqueSubscriptions: number;
    ...
    static EPublishedFileRevision: {
        ...
        "4": string;
        "5": string;
        ApprovedSnapshot: number;
        ApprovedSnapshot_China: number;
        Default: number;
        Latest: number;
        RejectedSnapshot: number;
        RejectedSnapshot_China: number;
    };
    ...
    static EPurchaseResultDetail: {
        ...
        BillingNameInvalidResemblesCreditCard: number;
        BlockedByUSGov: number;
        BundleTypeCannotBeGifted: number;
        BusinessStoreCountryCodeMismatch: number;
        ...
        GiftAlreadyOwned: number;
        GiftInvalidForRecipientRegion: number;
        GiftPricingImbalance: number;
        GiftRecipientNotSpecified: number;
        ...
        ItemsNotAllowedForCommercialUse: number;
        ItemsReservedForCommercialUse: number;
        ...
        PaymentMethodNotSupportedForProduct: number;
        PaymentMethodTemporarilyUnavailable: number;
        ...
        UserAssociatedWithManyCafes: number;
        UserNotAssociatedWithCafe: number;
    ...
    static ESteamDatagramMsgID: {
        ...
        "8": string;
        "9": string;
        ClientPingSampleReply: number;
        ClientPingSampleRequest: number;
        ClientToRouterSwitchedPrimary: number;
        ConnectOK: number;
        ConnectRequest: number;
        ConnectionClosed: number;
        DataClientToRouter: number;
        DataRouterToClient: number;
        DataRouterToServer: number;
        DataServerToRouter: number;
        Diagnostic: number;
        GameserverPingReply: number;
        GameserverPingRequest: number;
        GameserverRegistration: number;
        GameserverSessionEstablished: number;
        GameserverSessionRequest: number;
        Invalid: number;
        LegacyGameserverPingReply: number;
        NoConnection: number;
        NoSession: number;
        P2PBadRoute: number;
        P2PSessionEstablished: number;
        P2PSessionRequest: number;
        P2PStatsClient: number;
        P2PStatsRelay: number;
        RelayHealth: number;
        RelayToRelayPingReply: number;
        RelayToRelayPingRequest: number;
        RouterPingReply: number;
        RouterPingRequest: number;
        Stats: number;
    };

    static ESteamNetworkingSocketsCipher: {
        "0": string;
        "1": string;
        "2": string;
        AES_256_GCM: number;
    ...
    static ESteamNetworkingUDPMsgID: {
        "32": string;
        "33": string;
        "34": string;
        "35": string;
    ...
    static ESteamPipeOperationType: {
        "0": string;
        "1": string;
        "2": string;
        "3": string;
    ...
    static ESteamPipeWorkType: {
        "0": string;
        "1": string;
        Invalid: number;
        StageFromChunkStores: number;
    };

    static ESteamReviewScore: {
        "0": string;
        "1": string;
        "2": string;
        "3": string;
        ...
        "9": string;
        Mixed: number;
        MostlyNegative: number;
        MostlyPositive: number;
        Negative: number;
        None: number;
        OverwhelminglyNegative: number;
        OverwhelminglyPositive: number;
        Positive: number;
        VeryNegative: number;
        VeryPositive: number;
    };
    ...
    static EStreamControlMessage: {
        ...
        DeleteCursor: number;
        DisableHighResCapture: number;
        EnableHighResCapture: number;
        ...
        InputText: number;
        InputTouchFingerDown: number;
        InputTouchFingerMotion: number;
        InputTouchFingerUp: number;
        KeepAlive: number;
        ...
        SetActivity: number;
        SetCapslock: number;
        SetCaptureSize: number;
        SetCursor: number;
        SetCursorImage: number;
        SetFlashState: number;
        SetGammaRamp: number;
        SetIcon: number;
        SetKeymap: number;
        SetQoS: number;
        ...
        ToggleMagnification: number;
        TouchActionSetActive: number;
        TouchActionSetLayerAdded: number;
        TouchActionSetLayerRemoved: number;
    ...
    static EStreamDeviceFormFactor: {
        "0": string;
        "1": string;
        "2": string;
        "3": string;
    ...
    static EStreamHostPlayAudioPreference: {
        "0": string;
        "1": string;
        k_EStreamHostPlayAudioAlways: number;
        k_EStreamHostPlayAudioDefault: number;
    };

    static EStreamInterface: {
        "0": string;
        "1": string;
        "2": string;
        "3": string;
    ...
    static ETradeOfferConfirmationMethod: {
        "0": string;
        "1": string;
        "2": string;
        Email: number;
    ...
    static EUserReviewScorePreference: {
        "0": string;
        "1": string;
        "2": string;
        ExcludeBombs: number;
    ...
    static EVoiceCallState: {
        ...
        InitatedWebRTCSession: number;
        LocalMicOnly: number;
        None: number;
        NotifyingVoiceChatOfWebRTCSession: number;
        RequestedMicAccess: number;
        RequestedPermission: number;
        ScheduledInitiate: number;
        WebRTCConnectedWaitingOnIceConnected: number;
    };
    ...
    static E_STAR_GlyphWriteResult: {
        "0": string;
        "1": string;
        "2": string;
        "3": string;
...
declare namespace ts_steam_user {
    class EventEmitter {
